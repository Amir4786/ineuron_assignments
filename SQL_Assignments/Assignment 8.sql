...
## Q15:
SELECT * FROM DEPARTMENTS D INNER JOIN WORKER W WHERE D.DEPT_NAME= W.DEPARTMENT;
## Q16.
SELECT * FROM WORKER W RIGHT OUTER JOIN DEPARTMENTS D ON W.DEPARTMENT= D.DEPT_NAME WHERE W.DEPARTMENT IS NULL;